"""
This module provides low-level utility functions and definitions for generating noisy images
of circles and displaying them. It includes a named tuple `CircleParams` for handling circle
parameters, a function to draw circles using anti-aliased outlines, and another to generate
...
# The following function are the original ones from the Challenge
